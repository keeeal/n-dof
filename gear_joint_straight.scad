    ...
    difference() {
        union() {
            translate([0, 0, -5]) hull() {
                ...
                translate([-47, 0, 0]) chamfered_squylinder(5-tol_z, 24);
            }
            ...
            translate([-79,-15,-3.25]) gopro_male(20);
            translate([-79, 15,-3.25]) gopro_male(20);
        }
...
translate([-47, 0, 0]) rotate([0, 0, 360/44])
motor_gear();
